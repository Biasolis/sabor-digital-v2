...
export const getDashboardStats = async (req, res) => {
  ...
  try {
    // Para as estatísticas, consideramos a sessão de caixa aberta no dia de hoje.
    // Em um cenário real mais complexo, poderíamos considerar o "dia fiscal" do restaurante.
    ...
    // 4. Pedidos com status 'pending', 'in_progress', ou 'ready'
